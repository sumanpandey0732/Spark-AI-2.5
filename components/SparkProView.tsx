...
export const SparkProView: React.FC = () => {
    ...
    useEffect(() => {
        chatRef.current = geminiService.createChatSession({ model: 'gemini-2.5-pro' });
    }, []);
            ...
            <div className="p-4 border-t border-gray-700">
                ...
                <form onSubmit={handleSubmit} className="flex items-center space-x-2">
                    <input
                        ...
                        placeholder="Ask a complex question or request a code snippet..."
